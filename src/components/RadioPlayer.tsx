        ...
        <div className="mt-8 space-y-6">
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap justify-center items-center gap-x-3 gap-y-2 px-4">
              ...
              <span className={`${theme.subtext} text-[8px]`}>•</span>
              <a href="https://palpitesdobichohoje.com" target="_blank" rel="noopener noreferrer" className={`text-[10px] ${theme.text} hover:opacity-70 transition-colors uppercase tracking-widest`}>Palpites do Bicho</a>
            </div>
          </div>
        </div>
      </motion.div>
